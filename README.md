# Web Development Project 4 - *Wanderleaf*

Submitted by: **Ameya Patkare**

This web app: **...helps introduce people to various plants!**
...
The API I chose has a really limited free-tier so often times a plant that meets the criteria isn't found. It doesn't allow you to filter using multiple values for the same category and results are split across multiple pages so I had to use multiple API calls to get random plants to display to the user.
